...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname lookup-in-bst-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
; <use template for BST with additional atomic parameter k>
