...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname arbitrary-arity-tree-ops-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
;; Element -> Image
;; Render element and recursively render all subs
(check-expect (render--element empty) EMPTY-TREE)
(check-expect (render--element F1) (above
                                   (text "F1" TEXT-SIZE TEXT-COLOR)
                                   VSPACE
                                   EMPTY-TREE))
(check-expect (render--element D5) (above
                                   ...
                                   (beside
                                    (above
                                     ...
                                     EMPTY-TREE)
                                    EMPTY-TREE)))
(check-expect (render--element D4) (above
                                   ...
                                   (beside
                                    ...
                                    (above
                                      ...
                                      EMPTY-TREE)
                                    EMPTY-TREE)))
;(define (render--element e) EMPTY-TREE) ;stub
;(define (render--loe loe) EMPTY-TREE) ;stub
