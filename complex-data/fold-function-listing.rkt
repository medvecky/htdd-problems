...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname fold-function-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
;; (X Y -> Y) Y (listof X) -> Y
;; the abstract fold function for list of x
