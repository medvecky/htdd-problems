...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname graphs-v2-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; interp. the room's name, and list of rooms that the exits leads to
