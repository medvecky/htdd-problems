...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname closures-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(define (wider-than-only w loi)
  (local [(define (wider-then? i)
            (> (image-width i) w))]
    (filter wider-then? loi)))
