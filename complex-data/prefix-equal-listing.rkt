...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname prefix-equal-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (prefix=? lsta lstb)
  (cond
    [(empty? lsta) true]
    [(empty? lstb) false]
    [else (and (string=? (first lsta) ; String
               (first lstb)) ; String
