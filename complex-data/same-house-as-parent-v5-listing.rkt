...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname same-house-as-parent-v5-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
(define (count w)     
  ...
  ;; (fn-for-wiz Wh 1)
  ;; (fn-for-wiz Wc 2)
  (local [(define (fn-for-wiz w todo rsf) ; todo is (listof Wizard) wizards we still need to visit with fn-for wiz
