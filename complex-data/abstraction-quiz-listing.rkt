...
#reader(lib "htdp-intermediate-reader.ss" "lang")((modname abstraction-quiz-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
;  PROBLEM 1:
;  
...
;; (X Y -> Y) Y (listof X) -> Y
;; Arrange consumed images ny consumed operation
...
(check-expect (arrange-all beside (rectangle 0 0 "solid" "white") empty) (rectangle 0 0 "solid" "white"))
(check-expect (arrange-all beside (rectangle 0 0 "solid" "white") (list (rectangle 50 40 "solid" "blue") (triangle 30 "solid" "pink")))
              (beside (rectangle 50 40 "solid" "blue") (triangle 30 "solid" "pink")))
(check-expect (arrange-all beside (rectangle 0 0 "solid" "white") (list (circle 10 "outline" "red") (circle 20 "outline" "blue") (circle 10 "outline" "yellow")))
              (beside (circle 10 "outline" "red") (circle 20 "outline" "blue") (circle 10 "outline" "yellow")))
...
;(define (arrnage-all fn b loi) b); stub
...
#;
(define (all-regions r)
  (fold-region cons append empty empty empty empty empty empty r))
