...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname skip1-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define (skip1 lox0)
  ;; acc: Natureal; 1 based postion of the (first lox) in lox0
  ;; (skip1 (list "a" "b" "c") 1)
  ;; (skip1 (list     "b" "c") 2)
  ;; (skip1 (list         "c") 3) 
