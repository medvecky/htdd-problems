...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname merge-sort-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
;; merge sort
