...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname same-house-as-parent-v3-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
; template from Wizard plus lost context accumulator
(define (same-house-as-parent w)          
  ;; parent-house is String; the house of this wizard immediate parent
