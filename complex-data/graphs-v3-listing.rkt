...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname graphs-v3-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;; template: structural recursion, encaplsulate w/ local, tail recursive w/ worklist,
