...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname same-house-as-parent-v4-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #t #t none #f () #f)))
...
;; template from wizard add and accumulator for tail recursion
...
;; function not correct, just temporary result
