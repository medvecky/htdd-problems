...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname render-bst-w-lines-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
(define MTTREE (rectangle 20 1 "solid" "black"))
...
(check-expect (lines 60 130)
              (add-line (add-line (rectangle (+ 60 130) (/ 190 4) "solid" "black")
                                  (/ (+ 60 130) 2) 0
                                  (/ 60 2)         (/ 190 4)
                                  "light green")
                        (/ (+ 60 130) 2) 0
...
(define (lines lw rw)
  (add-line (add-line (rectangle (+ lw rw) (/ (+ lw rw) 4) "solid" "black")  ;background
                      (/ (+ lw rw) 2)  0
                      (/ lw 2)         (/ (+ lw rw) 4)
                      "light green")
            (/ (+ lw rw) 2)  0
