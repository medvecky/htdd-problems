...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname tuition-graph-listing) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)
...
(check-expect (chart (cons (make-school "S1" 8000) empty)) (beside
...
(check-expect (chart (cons (make-school "S2" 12000) (cons (make-school "S1" 8000) empty))) (beside/align "bottom"
                                                                                           (overlay/align "center" "bottom"
...
(check-expect (make-bar (make-school "S1" 8000)) (overlay/align "center" "bottom"
                                                                                 ...
                                                                                 (rectangle BAR-WIDTH (* 8000 Y-SCALE) "outline" "black")
                                                                                 (rectangle BAR-WIDTH (* 8000 Y-SCALE) "solid" BAR-COLOR)))
(check-expect (make-bar (make-school "S2" 12000)) (overlay/align "center" "bottom"
                                                                                 (rotate 90 (text "S2" FONT-SIZE FONT-COLOR))
                                                                                 (rectangle BAR-WIDTH (* 12000 Y-SCALE) "outline" "black")
                                                                                 (rectangle BAR-WIDTH (* 12000 Y-SCALE) "solid" BAR-COLOR)))
